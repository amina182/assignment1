public class Doctor {
    ...
    public Doctor(int doctorId, String doctorName, String doctorSurname, String doctorSpecialization){
        this.id = doctorId;
    ...
    public String compareSpecialization(Doctor doctor){
        if(this.specialization.equals(doctor.specialization)){
            return "same specializations";
        }
        else{
            return "different specializations";
        }
    }
